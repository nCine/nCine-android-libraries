...
ExternalProject_Add(project_${TARGET_VORBIS}
	...
	CMAKE_ARGS ${CMAKE_TOOLCHAIN_ARGS} -DOGG_LIBRARY=${DESTINATION_PATH}/ogg/${ARCH}/libogg.so -DOGG_INCLUDE_DIR=${DEST_OGG}/include -DBUILD_SHARED_LIBS=ON
...
ExternalProject_Add(project_${TARGET_VORBIS_STATIC}
	...
	CMAKE_ARGS ${CMAKE_TOOLCHAIN_ARGS} -DOGG_LIBRARY=${DESTINATION_PATH}/ogg/${ARCH}/libogg.a -DOGG_INCLUDE_DIR=${DEST_OGG}/include -DBUILD_SHARED_LIBS=OFF
	BUILD_COMMAND ${CMAKE_COMMAND} --build . --parallel
	BUILD_IN_SOURCE 0
