...
set(URL_VORBIS http://downloads.xiph.org/releases/vorbis/libvorbis-1.3.5.tar.gz)
set(URL_MD5_VORBIS 7220e089f3be3412a2317d6fde9e3944)
...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
	add_custom_command(TARGET project_${TARGET_VORBIS} POST_BUILD
		COMMAND ${TOOLCHAIN}/bin/${HOST}-strip -S ${DEST_VORBIS}/${ARCH}/libvorbis.so
		COMMAND ${TOOLCHAIN}/bin/${HOST}-strip -S ${DEST_VORBIS}/${ARCH}/libvorbis.a
		COMMAND ${TOOLCHAIN}/bin/${HOST}-strip -S ${DEST_VORBIS}/${ARCH}/libvorbisfile.so
		COMMAND ${TOOLCHAIN}/bin/${HOST}-strip -S ${DEST_VORBIS}/${ARCH}/libvorbisfile.a
